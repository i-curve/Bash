...
#=================================================
#	System Required: CentOS 6/7,Debian 8/9,Deepin,Ubuntu 16+
...
check_sys
check_version
[[ ${release} != "debian" ]] && [[ ${release} != "deepin" ]] && [[ ${release} != "ubuntu" ]] && [[ ${release} != "centos" ]] && echo -e "${Error} 本脚本不支持当前系统 ${release} !" && exit 1
start_menu
